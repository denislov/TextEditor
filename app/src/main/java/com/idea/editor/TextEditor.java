...
import com.idea.editor.common.OnKeyShortcutListener;
import com.idea.editor.lang.Language;
import com.idea.editor.lang.lua.LuaLanguage;
import com.idea.editor.util.Document;
import com.idea.editor.util.DocumentProvider;
import com.idea.editor.util.Lexer;
import com.idea.editor.view.YoyoNavigationMethod;
import java.io.File;
import com.idea.editor.lang.LanguageNonProg;
...
public class TextEditor extends TextEditorField {
    ...
    private OnKeyShortcutListener mKeyShortcutListener = new OnKeyShortcutListener() {
        @Override
